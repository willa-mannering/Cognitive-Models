...
class SAM:
    ...
    def __init__(self, ListLength, t=2, r=4, sam_a = .1, sam_b = .1, sam_c = .1, sam_d = .02, sam_e = .7, sam_f = .7, sam_g = .7, Kmax = 30, Lmax = 3):
    ...
    def free_recall(self):
        ...
        for res in response:
            ...
            while(self.L < self.Lmax):
                ...
                probSamp = (self.context_assoc*self.word_assoc[res])/sum(self.context_assoc*self.word_assoc[res])
...
def individual_recall(num_runs):
